...
int main(int argc, char** arg){
  ...
  HanoiDisc x;
  SUStackList<HanoiDisc>  fail(HanoiDisc(-69));
  SUStackList<HanoiDisc>  Holder1(HanoiDisc(atoi(arg[1])));
  SUStackList<HanoiDisc>  win(HanoiDisc(atoi(arg[1])));
  SUStackList<HanoiDisc>  Holder2;
  SUStackList<HanoiDisc>  Holder3;
  //don't call any holdrs
  SUStack Stacks[3]={Holder1, Holder2, Holder3};
  int p;
